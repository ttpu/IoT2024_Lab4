...
// LCD display address and dimensions (change address if needed)
...
void setup() {
  ...
  // TODO: Display Wi-Fi connection status on LCD
  // TODO: Print IP address on LCD
  // TODO: Wait for 3 seconds before clearing the display
}
...
void loop() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    // TODO: Display local temperature on Row 1 of the LCD
    // TODO: Display other team's temperature on Row 2 of the LCD
